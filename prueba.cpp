...
public:
    ...
    Vector operator + (Vector Vec); //Sobrecarga del operador "+" para realizar
    //la suma de vectores
    Vector operator - (Vector Vec); //Sobrecarga del operador "-" para realizar
...
/* Método en el cual se sobrecarga el operador "+"; por lo tanto se podrá utilizar
para la suma aritmética, como para suma de vectores. Lo anterior da como resultado
...
/* Método en el cual se sobrecarga el operador "-"; por lo tanto se podrá utilizar
para la resta aritmética, como para resta de vectores. Lo anterior da como resultado
un objeto de tipo Vector */
Vector Vector :: operator - (Vector Vec){
    return Vector(CoordX - Vec.CoordX, CoordY - Vec.CoordY);
}
...
cout<<endl<<endl<<"El vector resultante de la suma de vectores es: "<<endl;
Vec3.ImprimeVector();
//Se invoca al operador "-" sobrecargado, se realiza la resta de vectores
Vec3 = Vec1 - Vec2;
//Mostramos el vector resultante
